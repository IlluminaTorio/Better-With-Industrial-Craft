...
dependencies {
    minecraft("::${libs.versions.bta.get()}")
        ...
        // Too Many Blocks (NEI-like recipe viewer): optional integration, compile only
        compileOnly(files("libs/tmb-2.2.2.jar"))

        // BTWaila (block tooltip HUD): optional integration, compile only
