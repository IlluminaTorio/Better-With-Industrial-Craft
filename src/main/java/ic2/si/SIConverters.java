...
public final class SIConverters {
    ...
    public static void registerRecipes() {
        ...
        try {
            ...
            net.minecraft.core.item.Item crystalEmpty = (net.minecraft.core.item.Item)
                            Class.forName("sunsetsatellite.signalindustries.SIItems")
                                            .getField("signalumCrystalEmpty").get(null);
            
            turniplabs.halplibe.helper.RecipeBuilder.Shaped((String)ic2.IC2.MOD_ID)
                            .setShape(new String[]{"CsC", "SMS", "CsC"})
                            .addInput('M', (net.minecraft.core.item.IItemConvertible)ic2.IC2Blocks.machineBlock)
        ...
        try {
            turniplabs.halplibe.helper.RecipeBuilder.Shaped((String)ic2.IC2.MOD_ID)
                            .setShape(new String[]{" C ", "BMB", " C "})
                            .addInput('M', (net.minecraft.core.item.IItemConvertible)ic2.IC2Blocks.machineBlock)
                            .addInput('B', (net.minecraft.core.item.IItemConvertible)ic2.IC2Items.batteryRE)
                            .addInput('C', (net.minecraft.core.item.IItemConvertible)ic2.IC2Items.circuit)
                            .create("converter_eu_to_energy", ic2.IC2Blocks.converterEuToEnergy.getDefaultStack());
            turniplabs.halplibe.helper.RecipeBuilder.Shaped((String)ic2.IC2.MOD_ID)
                            .setShape(new String[]{" A ", "BMB", " A "})
                            .addInput('M', (net.minecraft.core.item.IItemConvertible)ic2.IC2Blocks.machineBlock)
                            .addInput('B', (net.minecraft.core.item.IItemConvertible)ic2.IC2Items.batteryRE)
