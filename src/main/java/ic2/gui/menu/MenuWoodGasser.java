...
public class MenuWoodGasser
extends MenuAbstract {
    public TileEntityWoodGasser tileEntity;
    public int fuel = 0;
    public int progress = 0;
    public int gas = 0;

    public MenuWoodGasser(ContainerInventory inventory, TileEntityWoodGasser tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlot(new Slot((Container)tileEntity, 0, 56, 17));
        this.addSlot(new Slot((Container)tileEntity, 1, 56, 53));
        this.addSlot(new Slot((Container)tileEntity, 3, 116, 17));
        this.addSlot(new SlotFurnace(inventory.player, (Container)tileEntity, 2, 116, 49));
        for (int y = 0; y < 3; ++y) {
            for (int x = 0; x < 9; ++x) {
