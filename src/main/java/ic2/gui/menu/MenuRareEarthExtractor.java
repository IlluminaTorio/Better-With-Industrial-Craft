...
public class MenuRareEarthExtractor
extends MenuAbstract {
    public TileEntityRareEarthExtractor tileEntity;
    public int progress = 0;
    public int energy = 0;
    public int rareEarth = 0;

    public MenuRareEarthExtractor(ContainerInventory inventory, TileEntityRareEarthExtractor tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlot(new SlotIC2Input((Container)tileEntity, 0, 56, 17));
    ...
    public void broadcastChanges() {
        ...
        for (ContainerListener crafter : this.containerListeners) {
            ...
            if (this.rareEarth != (int)this.tileEntity.rareEarth) {
                crafter.updateCraftingInventoryInfo((MenuAbstract)this, 2, (int)this.tileEntity.rareEarth);
            }
        }
        this.progress = this.tileEntity.progress;
        this.energy = this.tileEntity.energy;
        this.rareEarth = (int)this.tileEntity.rareEarth;
    }
    ...
    public void setData(int id, int value) {
        switch (id) {
            ...
            case 2: {
                this.tileEntity.rareEarth = value;
                break;
            }
        }
    }
