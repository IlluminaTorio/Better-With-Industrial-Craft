...
public class MenuElectricBlock
extends MenuAbstract {
    public TileEntityElectricBlock tileEntity;
    public int energy = 0;

    public MenuElectricBlock(ContainerInventory inventory, TileEntityElectricBlock tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlot(new SlotIC2Battery((Container)tileEntity, 0, 56, 17));
