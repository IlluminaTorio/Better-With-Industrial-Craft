...
public class MenuThermalGenerator
extends MenuAbstract {
    public TileEntityThermalGenerator tileEntity;
    public int fuel = 0;
    public int storage = 0;

    public MenuThermalGenerator(ContainerInventory inventory, TileEntityThermalGenerator tileEntity) {
